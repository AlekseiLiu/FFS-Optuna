...
path = '/home/aleksei/Work/Publications/IDEAL_journal/Computations/syne-tune/data/satimage-2/'

data = scipy.io.loadmat(path + 'satimage-2.mat')
...
np.savetxt(save_path + 'X_train.txt', X_train)
np.savetxt(save_path + 'y_train.txt', y_train)
